...
if __name__ == '__main__':
    y, fs = librosa.load(path=r"C:\Users\asus9\Documents\disentangled-speechMAE\examples\supp\10_original.wav")
    print(y.shape)
    print(compute_dnsmos(y))
    y, fs = librosa.load(path=r"C:\Users\asus9\Documents\disentangled-speechMAE\examples\supp\10_rec.wav")
    print(compute_dnsmos(y))
    y, fs = librosa.load(path=r"C:\Users\asus9\Documents\disentangled-speechMAE\examples\supp\10_ref.wav")
    print(compute_dnsmos(y))