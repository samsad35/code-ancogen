...
from .encoder_decoder_mel import MelDecoder, MelEncoder
...
class SpeechVQVAE(nn.Module):
    def __init__(self, num_hiddens, num_residual_layers, num_residual_hiddens,
                 num_embeddings, embedding_dim, commitment_cost, decay=0, mel_input: bool = False):
        ...
        if not mel_input:
            ...
            self._encoder = MelEncoder(1, num_hiddens,
                                       num_residual_layers,
                                       num_residual_hiddens)
        ...
        if not mel_input:
            ...
            self._decoder = MelDecoder(embedding_dim,
                                       num_hiddens,
                                       num_residual_layers,
                                       num_residual_hiddens)
