...
class HifiganGenerator(torch.nn.Module):
    ...
    def load_pretrained_model(self, load_path: str, remove_weight_norm_bool: bool = True):
        ...
        self.load_state_dict(checkpoint["generator"]["model"])
        if remove_weight_norm_bool:
            self.remove_weight_norm()
        loss = checkpoint["loss"]
        print(f"\t [Model HIFIGAN (generator) successfully loaded with loss: {loss}]")
